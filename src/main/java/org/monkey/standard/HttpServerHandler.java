...
import org.monkey.pojo.ParameterMap;
import org.monkey.pojo.PojoEndpointServer;
...
class HttpServerHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
    ...
    private void handleHttpRequest(ChannelHandlerContext ctx, FullHttpRequest req) {
        ...
        if (config.getSubprotocols().equals("")) {
            wsFactory = new WebSocketServerHandshakerFactory(getWebSocketLocation(req), null, true, config.getmaxFramePayloadLength());
        }else {
            wsFactory = new WebSocketServerHandshakerFactory(getWebSocketLocation(req), config.getSubprotocols(), true, config.getmaxFramePayloadLength());
        }
